...
public class Messager {
    ...
    private static String convertTypeNameForRawAndUnknownTypes(String name) {
    ...
    public static void printErrorAndWarning(Tree node, String name1, String name2,
                                            ErrorAndWarningKind res,
