...
public class SimpleOperationPermissionChecker implements OperationPermissionChecker {
    private final ProcessingEnvironment processingEnv;

    public SimpleOperationPermissionChecker(ProcessingEnvironment processingEnv) {
        this.processingEnv = processingEnv;
    }

    private Class<? extends Annotation> treeKindToAnnotation(Tree.Kind op) {
        switch (op) {
    ...
    @Override
    public boolean isOperationAllow(Tree.Kind operator, String type) {
        TypeElement clazz = this.processingEnv.getElementUtils().getTypeElement(type);
